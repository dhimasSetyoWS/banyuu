...
export default {
    layout: (h, page) => h(AuthenticatedLayout, { header: 'Edit Material' }, () => [page])
}
</script>
...
const form = useForm({
    title: 'Judul material yang sudah ada',
    content: '',
    course_id: '',
    subject: '',
...
<template>
    ...
    <form @submit.prevent="submit" class="max-w-5xl mx-auto pb-20">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <Link :href="route('dashboard.material.index')"
        ...
        <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-2">Judul Material</label>
        ...
        <div class="mt-4 flex justify-end">
            <button type="submit" :disabled="form.processing"
                ...
                <span v-else>Simpan Material</span>
            </button>
        </div>

...
export default {
    layout: (h, page) => h(AuthenticatedLayout, { header: 'Tambah Project Baru' }, () => [page])
}
</script>
...
const submit = () => {
    ...
    // form.post(...)
    alert("Project beserta soal berhasil disimpan (Cek Console)!");
};
    ...
    <div class="max-w-5xl mx-auto pb-20 relative">
        ...
        <form @submit.prevent="submit" class="space-y-8">
            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Judul Project</label>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Instruksi Project</label>
                        <div class="prose-editor-wrapper">
                            <QuillEditor v-model:content="form.content" contentType="html" theme="snow" toolbar="full"
                                placeholder="Tulis instruksi project di sini..." />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end pt-4">
                <button type="submit" :disabled="form.processing"
                    ...
                    <span v-else>Simpan Project</span>
                </button>
            </div>

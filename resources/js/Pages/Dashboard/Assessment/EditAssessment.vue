...
export default {
    layout: (h, page) => h(AuthenticatedLayout, { header: 'Edit Assessment' }, () => [page])
}
</script>
...
const form = useForm({
    title: 'Judul assesment yang sudah ada',
...
<template>
    ...
    <form @submit.prevent="submit" class="max-w-5xl mx-auto pb-20">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <Link :href="route('dashboard.assessment.index')" class="flex items-center gap-2 text-sm text-slate-500 hover:text-indigo-600 transition">
        ...
        <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-slate-50 p-6 rounded-xl border border-slate-200">
                ...
                <div v-if="form.type === 'quiz'">
                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-wide mb-2">Durasi (Menit)</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-wide mb-2">KKM (Nilai Lulus)</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div>
                    ...
                    <div class="prose-editor-wrapper">
                        <QuillEditor v-model:content="form.description" contentType="html" theme="snow" toolbar="minimal"
                            placeholder="Tuliskan instruksi detail atau deskripsi tugas di sini..." />
                    </div>
                    <p class="text-xs text-slate-400 mt-2">Jelaskan peraturan ujian atau detail tugas yang harus dikerjakan siswa.</p>
                </div>
                ...
                <div>
                    ...
                    <div v-if="!form.file" class="relative group">
                        ...
                        <label for="file-upload"
                            ...
                            <div class="flex flex-col items-center gap-2 text-slate-400 group-hover:text-indigo-600 transition">
                    ...
                    <div v-else class="flex items-center justify-between w-full p-4 border border-indigo-200 bg-indigo-50 rounded-xl animate-fade-in">
                        ...
                        <button type="button" @click="removeFile"
                            class="p-2 text-slate-400 hover:text-red-500 hover:bg-white rounded-lg transition" title="Hapus File">
